...
import backend.dto.LeaveDtos.LeaveBalanceResponse;
...
public class LeaveService {
    ...
    public LeaveBalanceResponse getBalance() {
        ...
        int taken =
                18 - current.getLeaveBalance();

        return new LeaveBalanceResponse(
                Math.max(taken, 0),
                current.getLeaveBalance()
        );
    }

    public LeaveResponse apply(
    ...
    public LeaveResponse decide(
        ...
        if (manager.getRole() != Role.MANAGER) {
            ...
            throw new ResponseStatusException(
                    ...
                    "Only managers can decide leave requests"
            );
        }
        ...
        if (employee.getManager() == null
            ...
            throw new ResponseStatusException(
                    HttpStatus.FORBIDDEN,
                    "You can only decide leave for your own team"
            );
        }
